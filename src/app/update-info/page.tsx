...
export default function UpdateInfoPage() {
  ...
  if (status === 'loading' || !session || session.provider === 'google') {
    return null
  }

  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Update Profile</h1>
      <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="email" {...field} className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white" />
                    </FormControl>
